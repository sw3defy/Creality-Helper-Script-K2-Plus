...
main_menu() {
    ...
    echo -e "   ${YELLOW}10)${NC} ${GREEN}OctoEverywhere${NC}"
    echo -e "   ${YELLOW}11)${NC} ${GREEN}Mobileraker Companion${NC}"
    echo -e "   ${YELLOW}12)${NC} ${GREEN}Git Backup${NC}"
    echo ""
    echo -e "  ${WHITE}[Remove] Menu${NC}"
    echo -e "   ${YELLOW}13)${NC} ${GREEN}Remove a feature${NC}"
    echo ""
    echo -e "  ${WHITE}[Backup & Restore] Menu${NC}"
    echo -e "   ${YELLOW}14)${NC} ${GREEN}Backup Klipper configuration${NC}"
    echo -e "   ${YELLOW}15)${NC} ${GREEN}Restore Klipper configuration${NC}"
    echo ""
    echo -e "  ${WHITE}[Tools] Menu${NC}"
    echo -e "   ${YELLOW}16)${NC} ${GREEN}Restart Klipper${NC}"
    echo -e "   ${YELLOW}17)${NC} ${GREEN}Restart Moonraker${NC}"
    echo -e "   ${YELLOW}18)${NC} ${GREEN}Restart Nginx${NC}"
    echo -e "   ${YELLOW}19)${NC} ${GREEN}View Klipper log${NC}"
    echo -e "   ${YELLOW}20)${NC} ${GREEN}View Moonraker log${NC}"
    echo -e "   ${YELLOW}21)${NC} ${GREEN}Show installed features${NC}"
    echo ""
